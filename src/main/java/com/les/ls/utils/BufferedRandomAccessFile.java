...
public final class BufferedRandomAccessFile extends RandomAccessFile {
    ...
    private void init(String name, String mode, int bufbitlen) throws IOException {
        ...
        if (bufbitlen < 0) {
            throw new IllegalArgumentException("缓冲字节长度为0！");
        }
    ...
    public void write(byte b[], int off, int len) throws IOException {
        ...
        if (writeendpos <= this.bufendpos) {
            ...
            //(int)(this.curpos - this.bufstartpos + len - 1);
    ...
    public static void main(String[] args) throws IOException {
        ...
        brafReadFile = new BufferedRandomAccessFile("C:\\Users\\lenovo\\Desktop\\xml.xml");
        readfilelen = brafReadFile.initfilelen;
        brafWriteFile = new BufferedRandomAccessFile("C:\\Users\\lenovo\\Desktop\\xml01.xml", "rw", 10);
        ...
        java.io.FileInputStream fdin = new java.io.FileInputStream("C:\\Users\\lenovo\\Desktop\\xml.xml");
        java.io.BufferedInputStream bis = new java.io.BufferedInputStream(fdin, 1024);
        java.io.DataInputStream dis = new java.io.DataInputStream(bis);

        java.io.FileOutputStream fdout = new java.io.FileOutputStream("C:\\Users\\lenovo\\Desktop\\xml02.xml");
